...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	  <div> <a href="#"><img src="{{ asset('frontend/cssfiles/images/items/15.jpg') }}"></a></div>
	</div> <!-- slider-product.// -->
	<div class="thumbs-wrap">
	  <a href="#" class="item-thumb"> <img src="{{ asset('frontend/cssfiles/images/items/15.jpg') }}"></a>
	  <a href="#" class="item-thumb"> <img src="{{ asset('frontend/cssfiles/images/items/15-1.jpg') }}"></a>
	  <a href="#" class="item-thumb"> <img src="{{ asset('frontend/cssfiles/images/items/15-2.jpg') }}"></a>
	  <a href="#" class="item-thumb"> <img src="{{ asset('frontend/cssfiles/images/items/15-1.jpg') }}"></a>
	</div> <!-- slider-nav.// -->
