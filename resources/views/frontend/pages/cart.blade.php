...
<tr>
	<td>
		<figure class="itemside">
			<div class="aside"><img src="{{ asset('frontend/cssfiles/images/items/2.jpg') }}" class="img-sm"></div>
			<figcaption class="info">
...
<tr>
	<td>
		<figure class="itemside">
			<div class="aside"><img src="{{ asset('frontend/cssfiles/images/items/3.jpg') }}" class="img-sm"></div>
			<figcaption class="info">
