		...
		<div class="row">
				<div class="col-md-6">
					<figure class="itemside mb-4">
						<div class="aside"><img src="{{ asset('frontend/cssfiles/images/items/1.jpg') }}" class="border img-md"></div>
				...
				<div class="col-md-6">
					<figure class="itemside mb-4">
						<div class="aside"><img src="{{ asset('frontend/cssfiles/images/items/2.jpg') }}" class="border img-md"></div>
						<figcaption class="info">
				...
				<div class="col-md-6">
					<figure class="itemside mb-4">
						<div class="aside"><img src="{{ asset('frontend/cssfiles/images/items/3.jpg') }}" class="border img-md"></div>
						<figcaption class="info">
